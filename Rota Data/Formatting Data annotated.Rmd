...
As for what is in the values... For Y1, Y2, Y3, Y4, it's the detection record (0, 1, or NA) for each day in which the camera was operating. [Katie: I think it's just getting 0s and 1s, not NAs]
