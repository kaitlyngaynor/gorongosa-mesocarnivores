...
DON'T FORGET: this assumes the cameras never stop working and then start again (vectors are only added to until the first NA, then it stops). This will need to be addressed if that's not the case for some of our cameras, which I (Katie) need to check. 
