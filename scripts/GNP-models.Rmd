...
#Katie trying to address the ragged indexing, but not correct as is:
#total number of days active per camera
#cday <- apply(genet_dh, 1, function(x) sum(is.na(x) == F))

# Stan does not support ragged indexing.  This is a work-around
#I think this would need 
#start <- 1
#for(i in 2:nrow(genet_dh)){
