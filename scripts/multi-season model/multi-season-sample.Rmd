...
years <- matrix(years, nrow(crossbill), 9, byrow=TRUE) #creates a matrix with each of the years across the rows, and a row for each site (another colext example does the same)
