...
```{r}
years <- as.character(1999:2007) #I believe this just creates a list with the relevant years?
years <- matrix(years, nrow(crossbill), 9, byrow=TRUE) #creates a matrix with each of the years across the rows, and a row for each site
