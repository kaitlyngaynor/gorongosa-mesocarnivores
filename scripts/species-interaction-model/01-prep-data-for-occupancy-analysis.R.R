...
GNP_covariates <- select(cam_meta, StudySite, urema_dist, pans_dist, river_dist, tree_hansen, termite.large.count.100m, lion_camera, lion_latedry, fire_frequency, pans_100m, termites_250m, termites_500m, termites_1km, detect.obscured, cover.ground)

#added covariates (pan and river distance and study site, plus additional termite columns) in 2023
